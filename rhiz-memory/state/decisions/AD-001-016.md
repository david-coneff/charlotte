# Architecture Decisions — Migration, engine partitioning & resume

The broodforge→charlotte migration, repo scaffolding, the report.js / crawl.js module splits, the resumable-crawl journal, on-demand re-check, and live re-tuning.
