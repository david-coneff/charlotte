...
| Section | File |
|---|---|
| Suite orientation + tool picker | [`preamble`](CRAWLER/CRAWLER_part_01_preamble.md) |
| `crawl.js` — Node crawler (start here) | [`crawl.js`](CRAWLER/CRAWLER_part_02_crawljs-node-crawler-recommended.md) |
| `crawl-gui.hta` — Windows GUI | [`crawl-gui.hta`](CRAWLER/CRAWLER_part_03_crawl-guihta-windows-gui.md) |
| `web-crawler.html` — in-browser | [`web-crawler.html`](CRAWLER/CRAWLER_part_04_web-crawlerhtml-in-browser-crawler.md) |
