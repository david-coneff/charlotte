...
+ "document.addEventListener('click',function(e){var a=e.target;while(a&&a.nodeName!=='A')a=a.parentNode;if(!a||a.getAttribute('target')!=='_blank'||!a.href)return;e.preventDefault();place(a.href);},false);})();</script>";
